...
- Данный репозиторий содержит кодовую базу для **разрабатываемой** версии на Drupal 8 и последующей миграции с Drupal 7.

### Описание

Это репозиторий для Drupal 8 версии. Ждём релиза, начинаем потихоньку делать "заготовку".
- в config/live/sync - заготовки конфигураций под структуру материалов dru.io
