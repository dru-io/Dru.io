 ...
 * )
 */
class CommentAnswerComment extends SqlBase {
  ...
  public function prepareRow(Row $row) {
    ...
    $is_comment_to_answer = $this->select('node', 'n')
      ->fields('n')
    ...
    // We only process comments which created to answer node type. Otherwise
    // we skip row.
    if ($is_comment_to_answer) {
