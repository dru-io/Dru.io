...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> <?php $action == 'flag' ? print 'icon-ok-1' : print 'icon-ok-circle'; ?>" rel="nofollow"></a>
  <?php else: ?>
