...
?>
<div id="header-links">
  <div class="header__tracker <?php dlcommunity_tracker_count() ? print 'new' : FALSE; ?>"
    <?php dlcommunity_tracker_count() ? print 'data-new-count="' . dlcommunity_tracker_count() . '"' : FALSE; ?>>
